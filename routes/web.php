...
Route::get('resetpassword', [\App\Http\Controllers\UserController::class, 'reset'])->name('password.reset');
Route::post('repassword', [\App\Http\Controllers\UserController::class, 'repassword'])->name('password.set');
